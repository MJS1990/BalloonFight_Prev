...
public class Weapon_Range : Weapon
{
    ...
    void Awake()
    {
        //muzzleAnimator = muzzleAnim.gameObject.GetComponent<Animator>();
        muzzlePos = new Vector2(transform.position.x + 0.17f, transform.position.y + 0.011f);
    ...
    void FixedUpdate()
    {
       ...
       if(transform.parent != null && transform.parent.gameObject.name == "Attachment")
       {
           if (transform.parent.gameObject.GetComponent<SpriteRenderer>().flipX)
           {
                ...
                muzzleAnim.transform.localPosition = new Vector3(0.17f, 0.01f, 0.0f);
           }
