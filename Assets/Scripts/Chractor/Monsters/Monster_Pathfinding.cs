        ...
        while (true)
        {
            ...
            switch (dir)
            {
                case findDirection.Top:
                    {
                        //코너 없는 장애물에 도달
                        if (tilemap.HasTile(new Vector3Int(tempPos.x, tempPos.y + 1, 0)) && tilemap.HasTile(new Vector3Int(tempPos.x + 1, tempPos.y + 1, 0)) && tilemap.HasTile(new Vector3Int(tempPos.x - 1, tempPos.y + 1, 0)))//tilemap.HasTile(new Vector3Int(tempPos.x, tempPos.y, 0))) 
                            return;
                ...
                case findDirection.Left:
                    {
                        if (tilemap.HasTile(new Vector3Int(tempPos.x - 1, tempPos.y, 0)) && tilemap.HasTile(new Vector3Int(tempPos.x - 1, tempPos.y + 1, 0)) && tilemap.HasTile(new Vector3Int(tempPos.x - 1, tempPos.y - 1, 0)))// || tilemap.HasTile(new Vector3Int(tempPos.x, tempPos.y, 0))) //코너 없는 장애물에 도달
                            return;
                ...
                case findDirection.Bottom:
                    {
                        if (tilemap.HasTile(new Vector3Int(tempPos.x, tempPos.y - 1, 0)) && tilemap.HasTile(new Vector3Int(tempPos.x + 1, tempPos.y - 1, 0)) && tilemap.HasTile(new Vector3Int(tempPos.x - 1, tempPos.y - 1, 0)))// || tilemap.HasTile(new Vector3Int(tempPos.x, tempPos.y, 0))) //코너 없는 장애물에 도달
                            return;
